...
function gameOver() {
    ...
    song.pause();
    setTimeout(function(){
        while(rejilla.firstChild) {         //Mientras rejillas tenga un hijo, lo elimina
...
// Lógica para el evento clic de selección de cada personaje
...
// Fnción para contar los eliminados y determinar cuando acaba el juego con éxito
